...
/** `checkUpdate` 的结果：有更新 / 已是最新 / 当前构建未配置更新源 */
export type UpdateCheckOutcome = "available" | "up-to-date" | "unsupported";
...
export function UpdateProvider({ children }: { children: React.ReactNode }) {
  ...
  const checkUpdate = useCallback(async (): Promise<UpdateCheckOutcome> => {
    if (isCheckingRef.current) return "up-to-date";
