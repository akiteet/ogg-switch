...
import { OGG_RELEASES_URL, OGG_WEBSITE_URL } from "@/config/branding";
...
const TOOL_APP_IDS: Record<string, AppId> = {
  claude: "claude",
  codex: "codex",
  gemini: "gemini",
  grok: "grokbuild",
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-8">
            <div className="flex flex-col items-center gap-2">
              <div className="flex items-center gap-2">
                <img src={appIcon} alt="OGG Switch" className="h-5 w-5" />
          ...
          <div className="flex items-center gap-2">
            <Button
              ...
              variant="outline"
              size="sm"
              onClick={() => settingsApi.openExternal(OGG_WEBSITE_URL)}
              className="h-8 gap-1.5 text-xs"
            >
              <Globe className="h-3.5 w-3.5" />
              {t("settings.officialWebsite", { defaultValue: "官网" })}
            </Button>
            <Button
              type="button"
              size="sm"
