//! Deep link import functionality for OGG Switch
//!
//! This module implements the oggswitch:// protocol for importing configurations
...
///
/// Represents a parsed oggswitch:// URL ready for processing.
