...
//!
//! Parses oggswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a oggswitch:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// oggswitch://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "oggswitch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'oggswitch', got '{scheme}'"
        )));
    }
