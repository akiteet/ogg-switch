...
//!
//! This module is used when the Codex client talks to OGG Switch through the
...
mod tests {
    ...
    fn responses_request_to_chat_moves_tool_image_to_synthetic_user_message() {
        ...
        assert_eq!(
            ...
            "[ogg-switch: media output of tool call call_image]"
        );
    ...
    fn responses_request_to_chat_clamps_stringified_custom_output_residual_base64() {
        ...
        assert!(rewritten.contains("[ogg-switch: omitted 20000 bytes]"));
    ...
    fn responses_request_to_chat_clamps_only_residual_base64ish_strings() {
        ...
        assert!(tool_content[2]["data"]
            .as_str()
            .unwrap()
            .starts_with("[ogg-switch: omitted 20000 bytes]"));
